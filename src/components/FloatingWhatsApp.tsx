...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-[60px] h-[60px] bg-whatsapp rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform"
      aria-label="WhatsApp"
    >
      {/* Pulse ring */}
